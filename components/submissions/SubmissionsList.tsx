                    ...
                    <table className="min-w-full leading-normal">
                        <thead>
                            <tr>
                                ...
                                columns.map((column) => (
                                    <th key={column}
                                        className=" px-5 py-3 bg-gray-50 text-xs font-medium text-gray-500 uppercase tracking-wider">
                                        {column}
                                    </th>
                                ))
                                }
                        ...
                        <tbody>
                            <tr className=" dark:bg-gray-900 dark:border-gray-700">
                                ...
                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <p className="text-gray-600 whitespace-no-wrap text-center">
                                        3/4/06
                                    </p>
                                </td>
                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <a href="#" className="flex items-center p-2 text-base font-normal rounded-lg  hover:bg-gray-100 ">
                                        <span className="py-1 px-4 inline-flex justify-center items-center ml-3 text-sm font-medium text-blue-800 bg-gray-200 rounded-full ">Pending</span>
                                    </a>
                                </td>
